...
data = pd.read_csv(os.path.join(EXPERIMENTAL_DATA_PATH, "Reaction3", "r_3_NAD.csv"))
...
df_reaction1 = save_results(mc_reaction1_noisy_plate_reader, parameters, save_path=os.path.join(RESULTS_PATH, "MC_reaction3_full_experiment_NAD.csv"))
...
df_reaction1_2= save_results(mc_reaction1_noisy_plate_reader2, parameters, save_path=os.path.join(RESULTS_PATH, "MC_reaction3_rate_noise_NAD.csv"))
