...
data = pd.read_csv(os.path.join(EXPERIMENTAL_DATA_PATH, "Reaction3", "r_3_LACTOL.csv"))
...
df_reaction1 = save_results(mc_reaction1_noisy_plate_reader, parameters, save_path=os.path.join(RESULTS_PATH, "MC_reaction3_full_experiment_LACTOL.csv"))
