...
from parameter_estimator import (
    estimate_parameters, fit_parameters
)
...
class TestParameterEstimator(unittest.TestCase):
    ...
    def test_estimate_parameters_success(self, mock_fit_parameters, mock_make_fitting_data):
        ...
        result = estimate_parameters(self.test_model, self.test_concentrations, self.test_rates)
        
        # Überprüfe, dass beide Funktionen aufgerufen wurden
        mock_make_fitting_data.assert_called_once_with(self.test_model, self.test_concentrations, self.test_rates)
        mock_fit_parameters.assert_called_once_with(mock_substrate_data, mock_activities, self.test_model)
    ...
    def test_estimate_parameters_make_fitting_data_failure(self, mock_make_fitting_data):
        ...
        with self.assertRaises((TypeError, AttributeError)):
            estimate_parameters(self.test_model, self.test_concentrations, self.test_rates)
    ...
    def test_estimate_parameters_complete_workflow(self):
        ...
        with patch('parameter_estimator.make_fitting_data') as mock_make_fitting_data:
            ...
            result = estimate_parameters(self.test_model, test_concentrations, test_rates)
